    ...
    def train_step(self, real_images):
        ...
        for _ in range(self.n_critic):
            ...
            with tf.GradientTape() as ctape:
                ...
                gp = self.calculate_gradient_penalty(batch_size,real_images,fake_images)
                # add this penalty to c_cost 
                c_loss = c_cost + (self.gp_weight * gp)

            # calculate Gradients w.r.t to Critic loss
            c_gradient = ctape.gradient(c_loss, self.critic.trainable_variables)
        ...
        g_gradients = gtape.gradient(g_loss,self.generator.trainable_variables)
